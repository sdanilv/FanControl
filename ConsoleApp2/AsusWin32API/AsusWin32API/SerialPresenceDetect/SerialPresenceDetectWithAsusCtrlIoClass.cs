...
// Type: AsusWin32API.SerialPresenceDetect.SerialPresenceDetectWithAsusCtrlIoClass
...
{
  public class SerialPresenceDetectWithAsusCtrlIoClass : SMBusWithAsusCtrlIoClass
  {
    private List<byte> SPDList = new List<byte>();

    ~SerialPresenceDetectWithAsusCtrlIoClass()
    {
    }
    ...
    private bool SetSMBusMode(uint PCIRegisterAddress, bool IsI2CMode)
    {
      bool flag1 = false;
      uint pdwPortVal = 0;
      bool flag2 = this.g_AsusIoCtrlLib.SetPortVal(SMBusWithAsusCtrlIoClass.PCI_CONFIG_ADRESS, PCIRegisterAddress + 64U, (byte) 4);
      if (flag2)
        flag2 = this.g_AsusIoCtrlLib.GetPortVal(SMBusWithAsusCtrlIoClass.PCI_CONFIG_DATA, ref pdwPortVal, (byte) 1);
      if (flag2)
      {
        if (IsI2CMode)
          pdwPortVal |= 4U;
          ...
          pdwPortVal &= 251U;
        flag2 = this.g_AsusIoCtrlLib.SetPortVal(SMBusWithAsusCtrlIoClass.PCI_CONFIG_DATA, pdwPortVal, (byte) 1);
      }
      if (flag2)
        flag2 = this.g_AsusIoCtrlLib.SetPortVal(SMBusWithAsusCtrlIoClass.PCI_CONFIG_ADRESS, PCIRegisterAddress + 64U, (byte) 4);
      if (flag2)
        flag1 = this.g_AsusIoCtrlLib.GetPortVal(SMBusWithAsusCtrlIoClass.PCI_CONFIG_DATA, ref pdwPortVal, (byte) 1);
